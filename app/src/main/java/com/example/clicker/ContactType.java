...
public enum ContactType {
    ...
    CONTACT(R.raw.cc_yousuck2, "saw one on", new int[]{R.raw.f_upped, R.raw.cc_yousuck3}),
    FOLLOW(R.raw.cc_follow2, "lost one on", new int[]{R.raw.wtf_lookin, R.raw.cc_follow3});
