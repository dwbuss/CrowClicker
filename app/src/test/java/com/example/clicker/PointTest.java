...
public class PointTest {
    ...
    @Test
    public void testGetSingluarMessageCatchWithoutLength() throws ParseException {
        String csvRecord = "237\tDan\t-93.85824702680111\t49.21601569265263\t09-02-2021 09:11 AM\tCATCH\t61.5°\t\tSpoon\t\tTypical pike!\t'''''9.72 mph\tSE\t0.99\t54.06°\t1017.2 mb\t0.77\tCrow\tPike\t \t ";
        Point point = new Point(csvRecord);
        assertEquals("Dan caught a Pike on a Spoon.\nTypical pike!\n8:03 pm\nhttps://maps.google.com/maps?q=49.216016,-93.858247", point.getMessage("8:03 pm"));
    }

    @Test
    public void testGetPluralMessageCatchWithNoLength() throws ParseException {
        String csvRecord = "237\tDan\t-93.85824702680111\t49.21601569265263\t09-02-2021 09:11 AM\tCATCH\t61.5°\t\tBlades\t\tTypical pike!\t'''''9.72 mph\tSE\t0.99\t54.06°\t1017.2 mb\t0.77\tCrow\tMuskellunge\t20";
        Point point = new Point(csvRecord);
        assertEquals("Dan caught a Muskellunge on Blades.\nTypical pike!\n8:04 pm\nhttps://maps.google.com/maps?q=49.216016,-93.858247", point.getMessage("8:04 pm"));
    }
